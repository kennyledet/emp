...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join('%s%s' % (os.path.dirname(__file__), '/db/',), 'data.db'),  # Or path to database file if using sqlite3.
...
SECRET_KEY = 'isw+zm3*-lzl-mxtwwpty$4fl-%ts_8h)ch!@_vm5ruqq(^3*m'
