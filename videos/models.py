...
class Video(models.Model):
	...
	uploader 	= models.ForeignKey(User, blank=True, null=True) # set blank,null = True temporarily
	...
	vidtype		= models.CharField(max_length=10, blank=True)
	categories  = models.ManyToManyField(Category)
	favoriters	= models.ManyToManyField(User, related_name='+', blank=True)
